...
public class EtapasCliente extends ListActivity {
    String idResi;
    String EtapaId;
    ...
    private static String url_get_etapas = "http://172.16.128.186//android_connect/get_etapas_concluidas_cliente.php";
...
//                        MainActivity.class);
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EtapasCliente.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            EtapasCliente.this, productsList,
                            R.layout.list_item_etapa_cliente, new String[] { TAG_PID,
